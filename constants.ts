...
export const MOCK_VIDEOS: Video[] = [
  {
    id: 'promo-mostafa-nofal',
    title: 'Mostafa Nofal - The King of Social Studies',
    videoUrl: staticFilesUrl + 'Characters_intense_talking.mp4',
    description: `A promotional video for a Social Studies tutor named Mostafa Nofal.

Scene 1: Two middle school students are in a classroom, looking worried.
Student 1 says in Egyptian Arabic: "وبعدين بقا في مادة الدراسات اللي مش عارفين نذاكرها دي هنفضل لحظ امتى كدة مش فاهمينها"
Student 2's face lights up with an idea. He replies in Egyptian Arabic: "يااااه انت لسة شايل هم مادة الدراسات انا خلاص لقيت اللي هيظبطلي المادة دي ويخليني عبقري فيها وانت بردو مستني اي احجز دلوقتي مع الاستاذ مصطفى نوفل الملك في الدراسات الاجتماعية"

Scene 2: Transition to a sunny schoolyard. A middle-aged man with short dark hair, a beard, and a mustache, wearing a white button-down shirt and grey trousers, walks confidently towards the camera. This is Mostafa Nofal.
He speaks directly to the camera in Egyptian Arabic: "زي ما سمعت كدة احجز معانا دلوقتي عشان تضمن الدراسات في جيبك اخر السنة ومتنساش انك متشيلش هم درجات مع الملك في الدراسات"

Scene 3: Quick cut to a crowd of enthusiastic middle school students in the same schoolyard. They are behind Mostafa Nofal. They are holding signs featuring a golden logo with the letters 'MN' under a crown.
The students are chanting cheerfully in Egyptian Arabic: "الملك في الدراسات الملك في الدراسات"

Scene 4: The video ends with a full-screen shot of the golden logo. The logo features the letters 'MN' in a bold, 3D style inside a black and gold circle, topped with a golden crown and flanked by golden laurels. Below the circle is a black and gold ribbon with the text 'MOSTAFA NOFAL'.`,
  },
  {
    id: '1',
